...
.sequence_heads = T1_sequence_heads, .sequences_guards = semaphores_T1, .last_added_job = NULL, .seq_threads = task1_threads, .period = 117000,
...
.sequence_heads = T2_sequence_heads, .sequences_guards = semaphores_T2, .last_added_job = NULL, .seq_threads = task2_threads, .period = 317000,
...
void *(*seq_func_ptr[7])()  = {sequence_1_1_function, sequence_1_2_function, sequence_1_3_function, sequence_1_4_function, sequence_2_1_function, sequence_2_2_function, sequence_2_3_function};
